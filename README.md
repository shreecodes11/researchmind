...
The repository includes example outputs generated by the system:

### **Retrieved Papers Dataset**

"retrieved_papers.csv"

Contains metadata collected from arXiv, including:
...
These files are provided as sample outputs to demonstrate the functionality of the system.
